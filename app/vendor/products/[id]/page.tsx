    ...
    <div className="min-h-screen pb-24">
      ...
      <div className="mx-auto w-full max-w-[640px]">
        ...
        {vendor && (
          <div className="px-4 pt-5">
            <Link href={`/vendors/${vendor.id}`} className="block rounded-2xl border border-surface-3 bg-surface-1 p-4 transition-colors hover:border-primary/40">
              <div className="flex items-start gap-3">
                ...
                <span className="shrink-0 text-[12px] text-primary">View →</span>
              </div>
      ...
      <div className="fixed inset-x-0 bottom-0 z-30 mx-auto flex max-w-[1200px] items-center gap-2 border-t border-surface-3 bg-surface-1 p-4">
        ...
        <button
          ...
          className={cn(
            'flex flex-1 items-center justify-center gap-1.5 rounded-xl border border-primary py-3 text-[14px] font-semibold text-primary disabled:opacity-50',
          )}
        >
